...
import com.examFeb.repository.ArtistRepository;
...
public class ArtistServiceImpl implements ArtistService {
    ...
    @Override
    public ArtistEntity findByName(SingerEnum name) {
